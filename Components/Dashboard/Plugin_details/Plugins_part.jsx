...
import nagod from "../../../Assets/images/nagod.png";
          ...
          <div className='plugins_content'>
            <div className='row'>
              ...
              <div className='col-lg-3'>
                <div className='plugins_Details left'>
                  <div className='img'>
                    <Image
                      src={nagod}
              ...
              <div className='col-lg-9'>
                <div className='plugins_Details right'>
                  <h4>Plugins Details</h4>
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Curabitur proin ut odio eu dui molestie convallis. Massa
                    aliquam odio et hac ultrices viverra cras. Consectetur
                    volutpat pulvinar convallis dictum morbi pharetra morbi
                    mauris. Sit diam posuere consequat dui. Nisl consectetur
                    praesent sagittis, quam sed. Id diam adipiscing porttitor
                    felis. Amet, justo vitae pellentesque in gravida. Tempus,
                    fermentum eget iaculis non egestas morbi. Egestas diam quis
                    porttitor urna leo.
                  </p>
                  <h6>How to use plugin in the store ?</h6>
                  <ul>
                    <li>
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    </li>
                    <li>Curabitur proin ut odio eu dui molestie convallis.</li>
                    <li>Massa aliquam odio et hac ultrices viverra cras.</li>
                    <li>
                      Consectetur volutpat pulvinar convallis dictum morbi
                      pharetra morbi mauris.
                    </li>
                    <li>
                      Sit diam posuere consequat dui. Nisl consectetur praesent
                      sagittis, quam sed.
                    </li>
                    <li>
                      Id diam adipiscing porttitor felis. Amet, justo vitae
                      pellentesque in gravida.
                    </li>
                    <li>Tempus, fermentum eget iaculis non egestas morbi.</li>
                    <li>Egestas diam quis porttitor urna leo.</li>
                  </ul>
                </div>
                {/* Plugins */}
                <div className='plugins_content'>
